<template>
  <main-layout :title="title" :sidebar-menu="sidebarMenu">
    <card-page card-header-title="Create Workout">
      <v-card-actions>
        <v-btn color="primary" large class="pl-4 pr-4"> add exercise </v-btn>
      </v-card-actions>
      ...
      />
      <v-card-actions>
        <v-btn color="primary" large class="pl-4 pr-4"> create workout </v-btn>
      </v-card-actions>
    </card-page>
  </main-layout>
</template>
